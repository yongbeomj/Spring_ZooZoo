...
//                            System.out.println(obj);
                            ...
                            if(obj.get("REFINE_ROADNM_ADDR") == null ){address.add("정보없음");} else {address.add((String) obj.get("REFINE_ROADNM_ADDR"));}
                            if(obj.get("ROADNM_ZIP_CD") == null ){addrpost.add("정보없음");} else {addrpost.add((String) obj.get("ROADNM_ZIP_CD"));}
                            if(obj.get("LOCPLC_FACLT_TELNO") == null ){tel.add("정보없음");} else {tel.add((String) obj.get("LOCPLC_FACLT_TELNO"));}
                            if(obj.get("BSN_STATE_DIV_CD") == null ){code.add("정보없음");} else {code.add((String) obj.get("BSN_STATE_DIV_CD"));}
                            if(obj.get("LICENSG_DE") == null ){agreedate.add("정보없음");} else {agreedate.add((String) obj.get("LICENSG_DE"));}
                            if(obj.get("REFINE_LOTNO_ADDR") == null ){oldaddress.add("정보없음");} else {oldaddress.add((String) obj.get("REFINE_LOTNO_ADDR"));}
                            if(obj.get("REFINE_WGS84_LAT") == null ){addrX.add("정보없음");} else {addrX.add((String) obj.get("REFINE_WGS84_LAT"));}
                            if(obj.get("REFINE_WGS84_LOGT") == null ){addrY.add("정보없음");} else {addrY.add((String) obj.get("REFINE_WGS84_LOGT"));}
                            if(obj.get("BIZPLC_NM") == null ){name.add("정보없음");} else {name.add((String) obj.get("BIZPLC_NM"));}
