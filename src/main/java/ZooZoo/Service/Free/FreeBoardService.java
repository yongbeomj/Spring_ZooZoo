...
public class FreeBoardService {
        ...
        if (files.size() != 0) {
            for (MultipartFile temp : files) {
                ...
                if (temp.getOriginalFilename() == null || temp.getOriginalFilename().equals("")) {
                    ...
                    String filepath = "C:\\Users\\505\\IdeaProjects\\Spring_ZooZoo\\out\\production\\resources\\static\\IMG\\Board\\FreeBoardIMG\\" + uuidfile;
                    try {
    ...
    public void freeBoardFileDown(String bimg, HttpServletResponse response) {
        String path = "C:\\Users\\505\\IdeaProjects\\Spring_ZooZoo\\out\\production\\resources\\static\\IMG\\Board\\FreeBoardIMG\\" + bimg;
